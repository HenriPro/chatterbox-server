...
// var app = {
//   text: null,
//   username: this.location.search.slice(10, this.location.search.length),
//   friends: [],
...
//     contentType: 'application/json',
//     success: function(data) {
//       console.log('The function is properly fetching values from the server');
...
//     type: 'DELETE',
//     success: function(data) {
//       console.log('this invalid input has been deleted: ', data)
//     },
//     error: function(data) {
//       console.log('chatterbox: Failed to delete message', data)
//     }
//   });
// }
...
//   var username = /^[a-zA-Z0-9]+$/.exec(message.username);
//   var text = /^[a-zA-Z]+$/.exec(message.text);
//   if (username !== message.username || text !== message.text) {
//     //app.delete(message);
//   }
//   if (app.friends.includes(username)){
//     $('#chats').prepend(`<div class='chat'><h2 class='username'>${username}</h2> <p><b>${text}</b></p></div>`);
//   } else {
//     $('#chats').prepend(`<div class='chat'><h2 class='username'>${username}</h2> <p>${text}</p></div>`);
//   }
// };
...
// app.handleUsernameClick = function(htmlEl) {
//   if (!app.friends.includes(htmlEl.text())) {
//     app.friends.push(htmlEl.text());
//   }
  
//   console.log('is adding a friend', app.friends);
// };

// app.handleSubmit = function(htmlEl) {
//   var newMessage = {
//     username: app.username,
//     text: htmlEl.find('input').val(),
//   };
//   app.send(newMessage);
// };
